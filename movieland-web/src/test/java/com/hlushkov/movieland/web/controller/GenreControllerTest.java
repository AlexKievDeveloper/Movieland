...
import com.hlushkov.movieland.service.config.RootApplicationContext;
...
@SpringJUnitWebConfig(value = {TestConfiguration.class, RootApplicationContext.class, com.hlushkov.movieland.web.config.WebApplicationContext.class})
