...
public class TestConfiguration {
    ...
    public static class PostersAndMoviesProvider implements DataSetProvider {
        @Override
        public IDataSet provide() {
            return new DataSetBuilder()
                    .table("movies")
                    ...
                    .values("25",
                            ...
                            "134.67")
                    .table("posters")
                    .columns("poster_id", "movie_id", "poster_picture_path")
    ...
    public static class MoviesCountriesGenresReviewsUsers implements DataSetProvider {
        ...
        public IDataSet provide() {
            return new DataSetBuilder()
                    ...
                    .table("posters")
                    .columns("movie_id", "poster_picture_path")
