...
public class TestData {
    ...
    public static class UserAdminProvider implements DataSetProvider {
        @Override
        public IDataSet provide() {
            return new DataSetBuilder()
                    .table("users")
                    .columns("user_id", "user_nickname", "user_email", "user_password", "user_salt", "user_role")
                    .values("1", "admin", "admin@gmail.com", "d82494f05d6917ba02f7aaa29689ccb444bb73f20380876cb05d1f37537b7892", "admin", "admin")
                    .build();
        }
    }
    ...
    public static class RemoveReviewsResultProvider implements DataSetProvider {
        @Override
        public IDataSet provide() {
            return new DataSetBuilder()
                    .table("movies")
    ...
    public static class AddMovieResultProvider implements DataSetProvider {
        @Override
        public IDataSet provide() {
            return new DataSetBuilder()
                    .table("movies")
                    ...
                    .values("26",
                            ...
                            "1994",
                            "Успешный банкир Энди Дюфрейн обвинен в убийстве собственной жены и ее любовника. Оказавшись" +
                                    " в тюрьме под названием Шоушенк, он сталкивается с жестокостью и беззаконием, " +
                                    "царящими по обе стороны решетки. Каждый, кто попадает в эти стены, становится " +
                                    "их рабом до конца жизни. Но Энди, вооруженный живым умом и доброй душой, " +
                                    "отказывается мириться с приговором судьбы и начинает разрабатывать невероятно " +
                    ...
                    .values("24", "1").values("24", "7").values("24", "11").values("24", "15")
                    .values("25", "1").values("25", "11").values("25", "15")
                    .values("26", "1").values("26", "2").values("26", "3")
    ...
    public static class SaveMovieForDaoResultProvider implements DataSetProvider {
        @Override
        public IDataSet provide() {
            return new DataSetBuilder()
                    .table("movies")
...
/*                    .table("genres")
    ...
    public static class EditMoviesCountriesResultProvider implements DataSetProvider {
        @Override
        public IDataSet provide() {
            return new DataSetBuilder()
                    .table("movies")
    ...
    public static class EditMoviesGenresResultProvider implements DataSetProvider {
        @Override
        public IDataSet provide() {
            return new DataSetBuilder()
                    .table("movies")
    ...
    public static class SaveMovieServiceProvider implements DataSetProvider {
        @Override
        public IDataSet provide() {
            return new DataSetBuilder()
                    .table("movies")
    ...
    public static class SaveMovieServiceResultProvider implements DataSetProvider {
        @Override
        public IDataSet provide() {
            return new DataSetBuilder()
                    .table("movies")
